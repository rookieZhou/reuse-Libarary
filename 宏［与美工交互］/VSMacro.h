...
//计算retina屏线条
#define RetinaLine(CGFloat) CGFloat / [UIScreen mainScreen].scale
...
#define _ResizeImage(image)  (isIOS4 ? [image stretchableImageWithLeftCapWidth:10 topCapHeight:5] : [image resizableImageWithCapInsets:UIEdgeInsetsMake(image.size.height / 2, image.size.width / 2, image.size.height / 2 - 1, image.size.width / 2 - 1)])
